...
namespace ApiConsumer
{
    ...
    public abstract class BaseService
    {
        ...
        /// <param name="controllerMethodUrl">Controlador/acción a ejecutar</param>
        /// <param name="queryStringParameters">Diccionario de parámetros a enviar por querystring en la petición</param>
        ...
        /// <summary>
        /// Método encargado de realizar petición HTTP - POST
        /// </summary>
        /// <typeparam name="T">Modelo de respuesta según contrato</typeparam>
        /// <param name="apiUrl">Url/Host de la API</param>
        /// <param name="controllerMethodUrl">Controlador/acción a ejecutar</param>
